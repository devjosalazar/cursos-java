...
public class TransaccionServlet extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
        ...
        if (listaErrores.isEmpty()) {
            try (PrintWriter out = resp.getWriter()) {
                ...
                out.println("            <li>Codigo transacción: " + codigoTransaccion + "</li>");
            ...
            // }
            //out.println("<p><a href=\"/webapp-banco/\">volver</a></p>");
            System.out.println("Entro al de lo contrario");
    ...
    private void getDataRequest(HttpServletRequest req) {
        this.codigoTransaccion = req.getParameter("codigoTransaccion");
